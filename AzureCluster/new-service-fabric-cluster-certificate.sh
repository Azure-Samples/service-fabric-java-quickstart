...
# Last tested on Azure CLI 2.0 version 2.0.24.
...
# Example: mycluster.eastus2.cloudapp.azure.com
#declare certDNSName="mcollier-sf2018-2.eastus2.cloudapp.azure.com"
